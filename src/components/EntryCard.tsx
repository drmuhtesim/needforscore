...
const EntryCard = ({ entry, index }: Props) => {
  ...
  return (
    ...
    >
      ...
      <Link to={entryHrefSync(entry)} className="relative flex-1 min-w-0 grid grid-cols-[auto_1fr_auto] sm:grid-cols-[auto_1fr_auto_auto_auto] items-center gap-3 px-3 py-2.5">
        {/* Index + ikon */}
